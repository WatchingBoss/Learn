...
Texture::Texture(const char *pathname, eIMG_TYPE img_type) : m_Renderer(0) {
	...
	if (!t_data) sys_error("Failed to load texture");
...
Texture::~Texture() { GLCALL(glDeleteTextures(1, &m_Renderer)); }
