...
void Shader::SetUniform4f(const char *shaderVar, float f1, float f2, float f3,
                          float f4) const {
...
uint32 Shader::CreateShader(const std::string &v_source,
                            const std::string &f_source) {
	...
	if (!vs || !fs) sys_error("CreateShader:: CompileShader error");
