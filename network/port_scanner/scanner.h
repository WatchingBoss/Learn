...
extern int check_port(long *, long *, char *);
extern uint16_t checksum_comp(uint16_t *, int);
extern pcap_t* engine_preparing(char *, struct sockaddr_in **, pcap_t *);
extern struct hostent* host_resolve();
extern void syn_scanning();
extern void connect_scanning();
extern void sigfunc(int);
